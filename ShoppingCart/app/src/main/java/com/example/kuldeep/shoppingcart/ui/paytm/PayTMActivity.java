package com.example.kuldeep.shoppingcart.ui.paytm;
...
import com.example.kuldeep.shoppingcart.app.Constants;
...
public class PayTMActivity extends BaseActivity {
    ...
    private void init() {
        ...
        realm.where(CartItem.class).findAllAsync()
                .addChangeListener(new RealmChangeListener<RealmResults<CartItem>>() {
                    @Override
    ...
    void getChecksum(PrepareOrderResponse response) {
        ...
        final Map<String, String> paramMap = preparePayTmParams(response);
